...
def main():
    ...
    mods =cythonize(
            [
                ...
                Extension("yt_dlp.utils.__init__", ["yt_dlp/utils/__init__.py"]),
                Extension("yt_dlp.utils._deprecated", ["yt_dlp/utils/_deprecated.py"]),
                Extension("yt_dlp.utils._legacy", ["yt_dlp/utils/_legacy.py"]),
                Extension("yt_dlp.utils.traversal", ["yt_dlp/utils/traversal.py"]),
